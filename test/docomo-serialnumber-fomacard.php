...
require_once 'Net/UserAgent/Mobile/UserID/DoCoMo/SerialNumber/FomaCard.php';


$lime = new lime_test(null, new lime_output_color());


$module = new Net_UserAgent_Mobile_UserID_DoCoMo_SerialNumber_FomaCard();


$sample = array(
    'xxxxxxxxxxxxxxxxxxxx' => 'DoCoMo/2.0 P2101V(c100;serXXXXXXXXXXXXXXX;iccxxxxxxxxxxxxxxxxxxxx)',
);
foreach ($sample as $sample_id => $sample_ua) {
    $_SERVER['HTTP_USER_AGENT'] = $sample_ua;
    $userid = $module->getID();
    $lime->is('icc'.$sample_id, $userid);
